                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 mt-12">
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="text-lg text-gray-300 leading-relaxed space-y-4">
                                        ...
                                        <p>
                                            During the offseason created a full test chassis to test the innovative
                                            approach of using bare 6000 rpm drivetrain motors with a single stage belt
                                            reduction for weight saving.
                                        </p>
                                        <p>
                                            Optimised parts for 3d printing and manufactured most of the robot's parts
                                            with my own 3d printer.
                                        </p>
                                        <p>
                                            Prototyped 4 different hang version and helping to teach the team's rookies
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="text-lg text-gray-300 leading-relaxed space-y-4">
                                        <p>
                                            ...
                                            like the vision system
                                            implementation and command system implementation for to the team's lead
                                            programmer Nojus Adomaitis.
                                        </p>
                                        <p>
                                            Spent countless hours tuning autonomous paths and parallelizing arm
                                            movements during autonomous operation.
                                        </p>
                                    </div>
                                </div>
                            </div>
